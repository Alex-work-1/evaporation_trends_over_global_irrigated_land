...
for( class in classes){
  # --- Step 3: Get yearly global mean of ET  ---
  ...
  # get the world data mean by year
  ...
  # --- Step 4: Get yearly global mean of Precipitation  ---
  ...
  # --- Step 5: Get yearly global mean of PET  ---
  ...
  ggplot(merged_data, aes(x = ET, y = PET)) +
    ...
    geom_smooth(method = "lm",
                se = FALSE,
                color = "red") +
    labs(x = "Actual Evapotranspiration (mm / year)", y = "Potential Evapotranspiration (mm / year)") +
    theme_classic() +
  ...
  ggplot(merged_data, aes(x = ET, y = Precipitation)) +
    ...
    geom_smooth(method = "lm",
                se = FALSE,
                color = "red") +
    labs(x = "Actual Evapotranspiration (mm / year)", y = "Precipitation (mm / year)") +
    theme_classic() +
